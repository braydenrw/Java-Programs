...
public class RandomBSTSymbolTableTest {
    ...
    public void testSevenStrings() {
        ...
        RandomBSTSymbolTable<String,String> symtab = new RandomBSTSymbolTable<String,String>();
    ...
    public void testForVariety() {
        ...
        for (int n = 0; n < numTrees; n++) {
            RandomBSTSymbolTable<String,String> symtab2 = new RandomBSTSymbolTable<String,String>();
            for (int i = 0; i < strings.length; i++)
    ...
    public void testMobyDick() {
        RandomBSTSymbolTable<String,Counter> symtab = new RandomBSTSymbolTable<String,Counter>();
        try {
